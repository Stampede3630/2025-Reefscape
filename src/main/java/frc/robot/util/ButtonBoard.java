...
public class ButtonBoard extends CommandXboxController {
    ...
    public Trigger leftBumper() {
        return super.leftBumper().or(leftBumper::get).onTrue(Commands.runOnce(() -> leftBumper.set(false)));
    }

    @Override
    public Trigger leftBumper(EventLoop loop) {
        return super.leftBumper(loop).or(leftBumper::get).onTrue(Commands.runOnce(() -> leftBumper.set(false)));
    }

    @Override
    public Trigger rightBumper() {
        return super.rightBumper().or(rightBumper::get).onTrue(Commands.runOnce(() -> rightBumper.set(false)));
    }

    @Override
    public Trigger rightBumper(EventLoop loop) {
        return super.rightBumper(loop).or(rightBumper::get).onTrue(Commands.runOnce(() -> rightBumper.set(false)));
    }
    ...
    public Trigger leftStick() {
        return super.leftStick().or(leftStick::get).onTrue(Commands.runOnce(() -> leftStick.set(false)));
    }

    @Override
    public Trigger leftStick(EventLoop loop) {
        return super.leftStick(loop).or(leftStick::get).onTrue(Commands.runOnce(() -> leftStick.set(false)));
    }

    @Override
    public Trigger rightStick() {
        return super.rightStick().or(rightStick::get).onTrue(Commands.runOnce(() -> rightStick.set(false)));
    }

    @Override
    public Trigger rightStick(EventLoop loop) {
        return super.rightStick(loop).or(rightStick::get).onTrue(Commands.runOnce(() -> rightStick.set(false)));
    }
