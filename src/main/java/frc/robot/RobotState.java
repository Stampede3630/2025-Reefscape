...
public class RobotState {
  ...
  /**
   * Adds an odometry observation (encoders) to the robot state. This is used to update the robot's
   * pose.
   *
  ...
  /**
   * Adds a tx/ty observation to the robot state. This is used to update set of ty/ty poses based on
   * individual tags.
   *
  ...
  /**
   * Get 2d pose estimate of robot using the associated tx/ty estimate from the given tag, if not
   * stale.
   */
   ...
   * intaking and coral scoring. Uses a blend of the estimated pose and the tx/ty tag pose based on
   * the distance from the reef.
   */
