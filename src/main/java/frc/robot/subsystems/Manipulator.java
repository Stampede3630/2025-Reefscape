...
public class Manipulator extends SubsystemBase {
  private final TalonFX m_motor =
      new TalonFX(Constants.kManipulatorMotorId, Constants.kManipulatorCanBus);
    ...
    m_motor
        ...
        .apply(
            new TalonFXConfiguration()
                ...
                .withSlot0(
                    new Slot0Configs().withKS(70).withKV(0).withKA(0).withKP(10).withKI(10)));
  }

  public Command velocityCommand(DoubleSupplier _velocity) {
    return startEnd(
        () -> m_motor.setControl(m_velocityRequest.withVelocity(_velocity.getAsDouble())),
        () -> m_motor.stopMotor());
  }
